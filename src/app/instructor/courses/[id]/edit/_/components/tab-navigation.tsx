...
export type TabId = 'basic' | 'advanced' | 'curriculum' | 'submit';
...
interface TabNavigationProps {
  tabs: Tab[];
  activeTab: string;
  onTabChange: (tabId: 'basic' | 'advanced' | 'curriculum' | 'submit') => void;
  isLoading?: boolean;
  disabled?: boolean;
}
...
export const TabNavigation = React.memo<TabNavigationProps>(
  ({ tabs, activeTab, onTabChange, isLoading = false, disabled = false }) => {
    ...
    const handleTabClick = useCallback(
      (tabId: 'basic' | 'advanced' | 'curriculum' | 'submit', index: number) => {
