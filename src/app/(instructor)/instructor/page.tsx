...
export default function InstructorDashboard() {
  ...
  const quickActions = [
    { label: 'Create Course', href: ROUTES.instructor.courses.create, icon: Plus, color: 'orange' },
    // { label: 'View Analytics', href: '/instructor/analytics', icon: BarChart3, color: 'blue' },
    {
      label: 'Student Messages',
      href: ROUTES.instructor.chats.root,
      icon: MessageSquare,
      color: 'green',
    },
    ...
    <div className="p-6 space-y-8">
      ...
      >
        ...
        <div className="flex items-center space-x-6">
          <Link
            href={ROUTES.instructor.courses.create}
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <button
                        ...
                        onClick={() => {
                          router.push(ROUTES.instructor.courses.course(course.id));
                        }}
                      >
                        View Details
                      </button>
